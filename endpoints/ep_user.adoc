...
[NOTE]
The *Path* for each operation has been abbreviated by removing the `/accounts/{account_id}` prefix. You must include this in the full URL when issuing an actual API request. See link:../workflows/workflows.html[Administrative workflows] for more information.
