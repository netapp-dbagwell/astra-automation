...
Astra Control Service is used within the public cloud environment while Astra Control Center is for your on-premises deployments. There is one Astra REST API supporting both of these deployment models. Note there are some differences between the two in terms of the resources and workflows supported.
