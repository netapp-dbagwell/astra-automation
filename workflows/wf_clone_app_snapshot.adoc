...
[.lead]
You can create a new managed application by cloning it from an app snapshot.
...
Perform the workflow link:wf_list_snapshot.html[List the snapshot] and select snapshot you want to use.
